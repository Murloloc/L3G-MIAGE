...
public class MainWithStatic{
	...
	{
		OperationsArithmetiquesWithStatic opArith1 = new OperationsArithmetiquesWithStatic(5,14);
		OperationsArithmetiquesWithStatic opArith2 = new OperationsArithmetiquesWithStatic(3,17);
		
		System.out.println("Il y a "+OperationsArithmetiquesWithStatic.getnbOperations()+" operations");

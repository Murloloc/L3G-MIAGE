...
int main() {
    ...
    while (nbA < 1 || nbA > 50) {
        printf("Ce nombre d'eleves n'est pas accepte, re donnez un nombre compris entre 0 et 50\n");
        scanf("%d", &nbA);
    }
    ...
    if (moyenneA > moyenneB) {
        printf("La meilleure moyenne est la classe A avec une moyenne de :%.2f\n", moyenneA);
    } else if (moyenneA < moyenneB) {
        printf("La meilleure moyenne est la classe B avec une moyenne de :%.2f\n", moyenneB);
    } else {
        printf("Les deux moyennes sont egales et valent %.2f\n", moyenneA);
    }
    //Affichage meilleure note
    if (maxA > maxB) {
        printf("La meilleure note appartient a la classe A avec une valeur de :%.2f\n", maxA);
    } else if (maxA < maxB) {
        printf("La meilleure note appartient a la classe B avec une valeur de :%.2f\n", maxB);
    } else {
        printf("Les meilleures notes de la classe A et de la B sont égales et valent %.2f\n", maxA);
    }
    ...
    if (ecart_typeA > ecart_typeB) {
        printf("La classe A a l ecart type le plus important avec une valeur de :%.2f\n", ecart_typeA);
    } else if (ecart_typeA < ecart_typeB) {
        printf("La classe B a l ecart type le plus important avec une valeur de :%.2f\n", ecart_typeB);
    } else {
        printf("Les deux classes ont le meme ecart type avec une valeur de %.2f\n", ecart_typeA);
    }
    ...
    i = 0;
    printf("voici le tableau de notes de la classe A dans l'odre decroissant\n");
    while (i < nbA) {
        printf("%.2f\n", classeA[i]);
        i = i + 1;
    }
    ...
    i = 0;
    printf("voici le tableau de notes de la classe B dans l'odre decroissant\n");
    while (i < nbB) {
        printf("%.2f\n", classeB[i]);
        i = i + 1;
    }
    ...
    if (medianeA < medianeB) {
        printf("La classe A a la mediane la plus faible avec une valeur de :%.2f\n", medianeA);
    } else if (medianeA > medianeB) {
        printf("La classe B a la mediane la plus faible avec une valeur de :%.2f\n", medianeB);
    } else {
        printf("Les deux classes ont la meme mediane la plus faible avec une valeur de %.2f\n", medianeA);
    }
